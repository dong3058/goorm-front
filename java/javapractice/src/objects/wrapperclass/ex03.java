...
public class ex03 {
    ...
    //  정수 자료형들에만 존재
    //  ⭐ CharSequence : String 등이 구현하는 인터페이스
    int int_123_oct = Integer.parseInt("123", 8);//123은 83을 8진수로 나타낸거다
    ...
    String strSample = "Ab가1 .";
        ...
        System.out.printf(
                ...
                Character.isDigit(c),
                Character.isSpaceChar(c)//스페이스 즉 공백인지.
        );
    }
    ...
    boolean compByOp1 = intA == intB; // ⚠️ 값은 같으나 다른 참조 왜냐면 인스턴스이니까
    ...
    // 즉 숫자 자료형간에는 자유로운 변환이 가능한대 단 값에서 오류가 날수도있다.
