...
public class Main {
    public static void main(String[] args) {
        ...
        int menu2NewPrice = menu2.getPrice();//16000으로 변경된값이 적용됨
        ...
        YalcoChickenMenu[] byNames = new YalcoChickenMenu[] {
                YalcoChickenMenu.valueOf("FR"),//valueof는enum의 자체 메서드.즉 클래스메서드.
                YalcoChickenMenu.valueOf("PP"),
                YalcoChickenMenu.valueOf("GJ"),
                //  YalcoChickenMenu.valueOf("NN"), // ⚠️ 런다임 에러
        };

        //  💡 name 메소드 : 각 항목의 이름 반환 인스턴스 메서드임.
        String[] names = new String[] {
                menu1.name(), menu2.name(), menu3.name()//그니까 enum정의시 붙인값 을 의미함.
        };

        //  💡 ordinal 메소드 : 순번 반환
        int[] orders = new int[] {//0부터새서 몇번쨰인지를 돌려주는애.
                menu1.ordinal(), menu2.ordinal(), menu3.ordinal()
        };

        //  💡 values 메소드 : 전체 포함된 배열 반환
        //  YalcoChickenMenu[] 자료형
        YalcoChickenMenu[] menus = YalcoChickenMenu.values();//배열꼴로반환
