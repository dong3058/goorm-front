...
public class Main {
    public static void main(String[] args) {
        ...
        //  hash코드를 오버라이드하면 기본 toString에도 영향 아하!
        ...
        String str1 = new String("Hello");//내용이 같으므로 str1,2는 해시값도 같다.
        //str1==str2는 false이다. 즉 인스턴스를 생성햇는대 주소는 같지만 서로 다른취급.

        //만일 그냥 str2="hello"이면 ==이성립.
        String str2 = new String("Hello");
        String str3 = new String("World");

        boolean bool = str1 == str2;//false값 나옴.
